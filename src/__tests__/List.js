  ...
  describe("sort function", () => {
    it("should sort the Lecture components by title descending", () => {
      list
        .find("button")
        .find("#title")
        .simulate("click", { target: { id: "title" } });
    ...
    it("should sort the Lecture components by date descending", () => {
      list
        .find("button")
        .find("#pubDate")
        .simulate("click", { target: { id: "pubDate" } });
      ...
      expect(
        list
          ...
          .props()
          .pubDate.toString()
      ).toEqual("Tue Jun 23 2015 18:15:00 GMT+0100 (British Summer Time)");
    });
    ...
    it("should sort the Lecture components by date ascending", () => {
      ...
      expect(
        list
          ...
          .props()
          .pubDate.toString()
      ).toEqual("Tue Apr 18 2017 18:15:00 GMT+0100 (British Summer Time)");
    });
  });
  ...
  describe("search function", () => {
    it("should search the lecture title for the specified string", () => {
      list
        .find("input")
        .find("#searchString")
        .simulate("change", { target: { value: "some other title" } });
    ...
    it("should search the lecture subtitle for the specified string", () => {
      list
        .find("input")
        .find("#searchString")
        .simulate("change", { target: { value: "some subtitle" } });
    ...
    it("should display no lectures when there are no search results", () => {
      list
        .find("input")
        .find("#searchString")
        .simulate("change", { target: { value: "szxcxzcxc" } });
    ...
    it("should not search if the string is less than 3 characters", () => {
      list
        .find("input")
        .find("#searchString")
        .simulate("change", { target: { value: "so" } });
  ...
  describe("filter function", () => {
    it("should display lectures from a specific year", () => {
      list
        .find("button")
        .find("#y2015")
        .simulate("click", { target: { id: "y2015" } });
